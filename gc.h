...
enum CType {
	_Struct,
	_List, _String, _Element, _FRect, _LetterC, _Detection, _LocalC, _PopupC, _Select, _State, _LineC, _VLineC, _ImageC, _TabC, _DropC, _DownC, _Background, _SIValues, _SIVal,
