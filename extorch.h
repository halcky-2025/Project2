...
CustomModuleImpl* GoThread(ThreadGC* thgc) {
    ...
    GC_register_class(thgc, CType::_DropC, "Drop", sizeof(NewDrop), NULL, NULL);
    GC_register_class(thgc, CType::_DownC, "Down", sizeof(NewDown), NULL, NULL);
    GC_register_class(thgc, CType::_TabC, "Tab", sizeof(NewTab), NULL, NULL);
    GC_register_class(thgc, CType::_PopupC, "Popup", sizeof(PopupWindow), NULL, NULL);
    GC_register_class(thgc, CType::_Background, "Background", sizeof(Background), NULL, NULL);
    GC_register_class(thgc, CType::_SIVal, "SIVal", sizeof(SIVal), NULL, NULL);
    GC_register_class(thgc, CType::_SIValues, "SIValues", sizeof(SIValues), NULL, NULL);
    ...
    drop->size.y = height; drop->size.x = 120;
    ...
    initNewDown(thgc, down2);
    NewDirectAddLast(thgc, local, pw, down2);
    reinitNewDown(thgc, down2, str2);
    NewLetter* let2 = (NewLetter*)GC_alloc(thgc, CType::_LetterC);
    initNewLetter(thgc, let2, getFont("sans", 16), LetterType::_Letter);
    let2->text = str2;
    let2->color = 0x000000FF;
    NewDirectAddLast(thgc, local, down2, let2);
    NewLine* line2 = (NewLine*)GC_alloc(thgc, CType::_LineC);
    initNewLine(thgc, line2);
    NewDirectAddLast(thgc, local, local, line2);
    NewTab* tab = (NewTab*)GC_alloc(thgc, CType::_TabC);
    initNewTab(thgc, tab);
    tab->font = getFont("sans", 16);
    NewElementAddLast(thgc, local, local, tab);
    NewLine* line = (NewLine*)GC_alloc(thgc, CType::_LineC);
    initNewLine(thgc, line);
    NewDirectAddLast(thgc, local, local, line);
    NewLetter* letter = (NewLetter*)GC_alloc(thgc, CType::_LetterC);
    initNewLetter(thgc, letter, getFont("sans", 16), LetterType::_Letter);
	letter->text = createString(thgc, (char*)"Hello,world!", 12, 1);
    letter->color = 0xFFFFFFFF;
    NewElementAddLast(thgc, local, (NewElement*)local, (NewElement*)letter);
